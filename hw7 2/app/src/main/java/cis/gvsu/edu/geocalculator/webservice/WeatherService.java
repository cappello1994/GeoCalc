...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/8cef3e9a9bf324f58fab66ecab7edc62";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                //Log.w("weatherservices", condition);
            ...
            Log.d("HI_IM_A_RESPONSE", Integer.toString(response));
